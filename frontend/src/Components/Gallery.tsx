...
export function SlideShow() {
  ...
  return (
    <div className="mt-10 w-full max-w-[90%] sm:max-w-[800px] md:max-w-[1000px]">
      <div className="slideshow-container w-full h-[calc(100vw/1.8)] sm:h-[400px] md:h-[500px] lg:h-[600px]">
      ...
      <div className="flex items-center justify-center mt-6">
        <button onClick={handlePrevSlide} className="text-[2rem] ">
          <BsArrowLeftCircle />
        </button>
        <button onClick={handleNextSlide} className="text-[2rem]">
          <BsArrowRightCircle />
        </button>
      </div>
    </div>
