...
export default function Navbar() {
  ...
  return (
    <nav className="z-[99999] shadow-md sm:shadow-none sm:flex sm:items-center sm:justify-center sticky top-0 bg-[#2a2a2a] p-4 ">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden sm:flex gap-3 pt-10 text-[0.8rem] md:text-[1rem] md:gap-6 items-center justify-ceneter ">
          <Link to="/" onClick={() => setShowNavMobile(false)}>
            <p className="text-white font-semibold hover:text-blue-300 focus:text-blue-300 font-dai">
              HOME
            </p>
          </Link>
          <Link to="/about">
      ...
      <div
        ...
        } navMobile fixed top-0 bg-white h-screen w-[300px] right-0`}
      >
        ...
        <div className="px-4">
          <Link to="/" onClick={() => setShowNavMobile(false)}>
            <p className="text-black pb-3 border-b-[1px] mb-6 border-b-[#000000]">
              HOME
            </p>
          </Link>
          <Link to="/about">
